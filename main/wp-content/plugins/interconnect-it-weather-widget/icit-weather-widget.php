	...
	class icit_weather_widget extends WP_Widget {
		...
		*/
		function __construct( ) {
			...
			parent::__construct( __CLASS__, __( 'ICIT Weather', 'icit_weather' ), $widget_ops);
				...
				<div class="weather-wrapper">
						...
						<div class="main">
							<div class="cond">
								...
								<div class="weather-wind-condition">
									<?php printf( $mph ?  __( '风力: %1$smph %2$s', 'icit_weather' ) : __( 'Wind: %3$skm/h %2$s', 'icit_weather' ), round( $data[ 'current' ][ 'speed'] * 2.24 ), $this->get_direction( $data[ 'current' ][ 'direction' ] ), round( $data[ 'current' ][ 'speed' ] * 3.6 ) ); ?>
								</div>
								<div class="weather-condition">
									<?php echo ucwords( $this->get_weather( $data[ 'current' ][ 'number' ] ) ); ?>
								</div>
								<div class="weather-humidity">
									<?php printf( __( '湿度: %s%%', 'icit_weather' ), $data[ 'current' ][ 'humidity' ] ); ?>
								</div>
							</div>
					...
					<?php } elseif ( $display == "right" ) { ?>
						...
						<div class="main">
							...
							<div class="break">
								<div class="weather-wind-condition">
									<?php printf( $mph ?  __( '风力: %1$smph %2$s', 'icit_weather' ) : __( '风力: %3$skm/h %2$s', 'icit_weather' ), round( $data[ 'current' ][ 'speed'] * 2.24 ), $this->get_direction( $data[ 'current' ][ 'direction' ] ), round( $data[ 'current' ][ 'speed' ] * 3.6 ) ); ?>
								</div>
								<div class="weather-humidity">
									<?php printf( __( '湿度: %s%%', 'icit_weather' ), $data[ 'current' ][ 'humidity' ] ); ?>
								</div>
...
<style type="text/css" media="screen">
	...
	#<?= $this->id ?> .weather-wrapper .main {
		width: 100%;
		background-image: url(wp-content/uploads/2015/11/47P58PICTRV.jpg);
