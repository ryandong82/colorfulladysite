...
= 2.4 =
* More colour customisations!

= 2.3.3 =
* Styling updates! And the temperature now shouldn't show as '-0'!
...
= 2.2 =
* You (hopefully) won't notice any difference except for a better error message
