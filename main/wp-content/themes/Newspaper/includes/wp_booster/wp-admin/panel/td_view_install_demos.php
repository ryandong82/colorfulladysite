...
<div class=" about-wrap td-admin-wrap theme-browser">
    <h1><?php echo TD_THEME_NAME ?>演示</h1>
    <div class="about-text">
        <p>
            Newspaper带给你6个独特的网站。我们的演示进行了仔细的测试，因此您不必从头开始创建一切。使用主题的演示，你知道哪些预定义模板是完美的设计，以开始建立。每个演示是完全可自定义的（字体，颜色和布局） -
            <a href="http://forum.tagdiv.com/introduction/" target="_blank">阅读更多</a>.
        </p>
    </div>
    <hr/>
        ...
        foreach (td_global::$demo_list as $demo_id => $stack_params) {
			...
			<div class="td-demo-<?php echo $demo_id ?> td-wp-admin-demo theme <?php echo $tmp_class ?>">
				...
				<div class="td-admin-checkbox td-small-checkbox">
                    ...
                    <p class="td-installed-text">演示已安装</p>
				</div>

				<div class="theme-actions">
					<a class="button button-secondary td-button-demo-preview" href="<?php echo td_global::$demo_list[$demo_id]['demo_url'] ?>" target="_blank">预览</a>
					<a class="button button-secondary td-button-install-demo" href="#" data-demo-id="<?php echo $demo_id ?>">安装</a>
                    <a class="button button-primary td-button-uninstall-demo" href="#" data-demo-id="<?php echo $demo_id ?>">取消安装</a>
                    <a class="button button-primary disabled td-button-installing-demo" href="#" data-demo-id="<?php echo $demo_id ?>">安装中...</a>
                    <a class="button button-secondary disabled td-button-demo-disabled" href="#"">安装</a>


                    <a class="button button-primary disabled td-button-uninstalling-demo" href="#" data-demo-id="<?php echo $demo_id ?>">取消安装中...</a>
				</div>
			</div>
		<?php } ?>
	</div>
