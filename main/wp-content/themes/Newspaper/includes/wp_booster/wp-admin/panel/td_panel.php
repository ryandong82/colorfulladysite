...
class td_panel {
    ...
    function register_theme_panel() {
        ...
        if (current_user_can( 'activate_plugins' )) {
            add_submenu_page("td_theme_welcome", 'Plugins', '插件', 'edit_posts', 'td_theme_plugins', array($this, "td_theme_plugins"));
        }
        add_submenu_page( "td_theme_welcome", 'Install demos', '安装演示', 'edit_posts', 'td_theme_demos',  array($this, "td_theme_demos") );
        add_submenu_page( "td_theme_welcome", 'Support', '支持', 'edit_posts', 'td_theme_support',  array($this, "td_theme_support") );
        add_submenu_page( "td_theme_welcome", 'System status', '系统状态', 'edit_posts', 'td_system_status',  array($this, "td_system_status") );
        add_submenu_page( "td_theme_welcome", 'Theme panel', '主题面板', 'edit_posts', 'td_theme_panel',  array($this, "td_theme_panel") );


        // shit hack for welcome menu
        global $submenu; // this is a global from WordPress
        $submenu['td_theme_welcome'][0][0] = '欢迎';
