...
?>
<form id="td_panel_import_export_settings" name="td_panel_import_export_settings" action="?page=td_theme_panel&td_page=td_view_import_export_settings&action_import=import_theme_settings" method="post" onsubmit="return confirm('你确定要导入此设置？\n它将覆盖你现在的！');">
	    ...
	    <div id="td-container-right">
	        ...
	        <div id="td-col-right" class="td-panel-content" style="min-height: 900px">
	            ...
	            <div id="td-panel-welcome" class="td-panel-active td-panel">
	                ...
	                <?php echo td_panel_generator::box_start('导入/导出主题设置'); ?>

	                <div class="td-box-row">
	                    <div class="td-box-description td-box-full">
	                        <span class="td-box-title">导出主题设置</span>
	                        <p>
	                            此框包含所有面板选项编码为字符串，所以你可以轻松复制它们并移动它们到另一个服务器。
	                        </p>
	                    </div>
	                ...
	                <div class="td-box-row">
	                    <div class="td-box-description td-box-full">
	                        <span class="td-box-title">导入主题设置</span>
	                        <p>粘贴你的主题设置字符串到这里，它们将在数据库中加载</p>
	                    </div>
	                    <div class="td-box-control-full">
	                        <?php
	                        echo td_panel_generator::textarea(array(
	                ...
	                <div class="td-box-row">
	                    <input type="submit" class="td-big-button td-button-remove-border" value="导入主题设置">
	                </div>
...
<?php if($show_update_msg == 1){?><script type="text/javascript">alert('导入完成！');</script><?php }?>
