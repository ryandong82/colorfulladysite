        ...
        $buffy .= '<div class="td-pulldown-sidebars-controller">
            ...
            <div class="td-pulldown-sidebars-list" id="' . $list_uniq_id . '">';
                    ...
                    $buffy .= '<div class="td_sidebars_for_replace" data-controlelr-id="' . $controler_unique_id . '">';
                            ...
                            $buffy .= '<div class="td-option-sidebar-wrapper"><a class="td-option-sidebar" data-area-dsp-id="' . $controler_unique_id . '" title="Default Sidebar"默认侧边栏</a></div>';
                    ...
                    $buffy .= '<div class="td-new-sidebar-input"><input type="text" name="' . $new_sidebar_field_uniq_id . '" id="' . $new_sidebar_field_uniq_id . '" class="td_new_sidebar_field" placeholder="创建侧边栏"><a class="td-button-add-new-sidebar" data-field-new-sidebar="' . $new_sidebar_field_uniq_id . '" data-sidebar-option-list="' . $list_uniq_id . '">创建</a></div>';
	    ...
	    $buffy = '
            <div class="td_wrapper_upload_control">
                ...
                <div class="td_upload_image_controls">
                    ...
                    <div><a id="' . $contro_unique_id . '_button" class="td_upload_button">上传</a><a id="' . $contro_unique_id . '_button_delete" class="td_delete_image_button ' . $class_hidden . '" data-control-id="' . $contro_unique_id . '">删除</a><script language="JavaScript">td_upload_image("' . $contro_unique_id . '");</script></div>
                </div>
            </div>';
