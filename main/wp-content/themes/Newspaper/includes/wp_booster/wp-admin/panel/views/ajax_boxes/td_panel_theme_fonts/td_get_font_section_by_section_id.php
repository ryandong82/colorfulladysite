...
class td_panel_custom_typography_ajax {
    ...
    public function get_font_size_list() {
        $buffy_font_size[0] = array('text' => '默认大小', 'val' => '' );
    ...
    public function get_line_height_list() {
        $buffy_line_height[0] = array('text' => '默认行高', 'val' =>'');
    ...
    public function get_td_font_style_list() {
        $buffy_font_style[] = array('text' => '默认字体风格', 'val' =>'');
        $buffy_font_style[] = array('text' => '斜体', 'val' =>'italic');
        $buffy_font_style[] = array('text' => 'Oblique', 'val' =>'oblique');
        $buffy_font_style[] = array('text' => '下沉 (删除斜体)', 'val' =>'normal');
    ...
    public function get_td_font_weight() {
        $buffy_font_weight[0] = array('text' => '默认粗细', 'val' => '');
        $buffy_font_weight[1] = array('text' => '正常', 'val' => 'normal');
        $buffy_font_weight[2] = array('text' => '粗体', 'val' => 'bold');
    ...
    public function get_td_text_transform() {
        $buffy_text_transform[] = array('text' => '默认文字', 'val' => '');
        $buffy_text_transform[] = array('text' => '大写', 'val' => 'uppercase');
        $buffy_text_transform[] = array('text' => '首字大写', 'val' => 'capitalize');
        $buffy_text_transform[] = array('text' => '小写', 'val' => 'lowercase');
        $buffy_text_transform[] = array('text' => '无 (正常字体)', 'val' => 'none');
    ...
    public function td_custom_typology_generate_font_controls() {
		...
		<div class="td-panel-fonts-header">
		    <div class="td-panel-font-description td-panel-font-family">字体系列</div>
			<div class="td-panel-font-description td-panel-font-size">大小</div>
		    <div class="td-panel-font-description td-panel-font-line-height">行高</div>
		    <div class="td-panel-font-description td-panel-font-style">风格</div>
		    <div class="td-panel-font-description td-panel-font-weight">粗细</div>
		    <div class="td-panel-font-description td-panel-font-transform">转换</div>
		</div>
	    <?php
