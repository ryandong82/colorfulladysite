...
$td_translation_map = array(
    //header search
    'View all results' => __('查看所有结果', TD_THEME_NAME),
    'No results' => __('没有结果', TD_THEME_NAME),

    'Home' => __('首页', TD_THEME_NAME),

    //mobile menu
    'CLOSE' => __('关闭', TD_THEME_NAME),

    //title tag
    'Page' => __('页面', TD_THEME_NAME),


    //blocks
    'All' => __('所有', TD_THEME_NAME),
    'By' => __('作者', TD_THEME_NAME),
    'Load more' => __('加载更多', TD_THEME_NAME),

    //breadcrumbs
    'View all posts in' => __('查看所有文章', TD_THEME_NAME),
    'Tags' => __('标签', TD_THEME_NAME),

    //article / page
    'Previous article' => __('上篇文章', TD_THEME_NAME),
    'Next article' => __('下篇文章', TD_THEME_NAME),
    'Authors' => __('作者', TD_THEME_NAME),
    'Author' => __('作者', TD_THEME_NAME),
    'RELATED ARTICLES' => __('相关文章', TD_THEME_NAME),   //on Newspaper 4 it was: SIMILAR ARTICLES
    'MORE FROM AUTHOR' => __('作者更多文章', TD_THEME_NAME),
    'VIA' => __('通过', TD_THEME_NAME),   //on Newspaper4 it was lowercase
    'SOURCE' => __('来源', TD_THEME_NAME), //on Newspaper4 it was lowercase
    'TAGS' => __('标签', TD_THEME_NAME),
    'SHARE' => __('分享', TD_THEME_NAME),
    'Continue' => __('继续', TD_THEME_NAME),
    'Read more' => __('阅读更多', TD_THEME_NAME),

    //comments


    'Name:' => __('名字:', TD_THEME_NAME),
    'Email:' => __('邮箱:', TD_THEME_NAME),
    'Website:' => __('网站:', TD_THEME_NAME),
    'Comment:' => __('评论:', TD_THEME_NAME),
    'LEAVE A REPLY' => __('回复', TD_THEME_NAME),  //on Newspaper4 it was lowercase
