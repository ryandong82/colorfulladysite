...
class td_cake {
    ...
    function td_cake_register_panel() {
        ...
        add_submenu_page( "td_theme_welcome", 'Activate theme', '激活主题', "edit_posts", 'td_cake_panel', array($this, 'td_cake_panel'), null );
    }
    ...
    function td_cake_panel() {
        ...
        <div class="about-wrap td-admin-wrap">
            <h1>激活<?php echo TD_THEME_NAME ?></h1>
            <div class="about-text" style="margin-bottom: 32px;">
                <p>
                    请激活<?php echo TD_THEME_NAME ?>享受主题全部好处。我们很抱歉这个额外的步骤，但我们建立了激活系统，以防止盗版我们的主题，这允许我们更好地服务于我们的付费用户。
    ...
    function td_cake_msg() {
        ...
        ?>
<!--        <div class="error">
            <p><?php echo '<strong style="color:red"> 请激活主题！</strong> - <a href="' . wp_nonce_url( admin_url( 'admin.php?page=td_cake_panel' ) ) . '">点击这里输入您的代码</a> - 如果这是一个错误，请在contact@tagdiv.com联系我们 - <a href="http://forum.tagdiv.com/how-to-activate-the-theme/">如何激活主题</a>'; ?></p>
        </div> -->
    <?php
    }
