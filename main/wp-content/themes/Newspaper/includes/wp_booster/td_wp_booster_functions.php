...
function load_wp_admin_css() {
    ...
    wp_enqueue_style('google-font-ubuntu', $td_protocol . '://fonts.useso.com/css?family=Ubuntu:300,400,500,700,300italic,400italic,500italic,700italic&amp;subset=latin,cyrillic-ext,greek-ext,greek,latin-ext,cyrillic'); //used on content
...
load_theme_textdomain('tgmpa', get_template_directory() . '/translation');
...
function td_custom_menu() {
    ...
    $wp_admin_bar->add_menu(array(
        'parent' => 'site-name',
        'title' => '<span class="td-admin-bar-red">主题面板</span>',
