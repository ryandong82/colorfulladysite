...
class td_fonts {
    ...
    static $font_stack_list = array(
        ...
        'fs_2' => '宋体, Helvetica, Arial, sans-serif',
        'fs_3' => '微软雅黑, "Times New Roman", Times, serif',
        'fs_4' => '黑体, "Hoefler Text", "Times New Roman", Times, serif',
        'fs_5' => '楷体, "Lucida Sans", "Lucida Grande", "Lucida Sans Unicode", Verdana, sans-serif',
        'fs_6' => '仿宋, Calibri, Trebuchet, sans-serif',
