        ...
        <div id="td-container-right">
            ...
            <div id="td-col-right" class="td-panel-content" style="min-height: 900px">
                ...
                <div id="td-panel-welcome" class="td-panel-active td-panel">
                    ...
                    <?php echo td_panel_generator::box_start('Newspaper 4 - Newspaper 6 更新'); ?>
                    ...
                    <div class="td-box-row">
                        ...
                        if (isset($old_newspaper_options) and is_array($old_newspaper_options)) {
                            // import the widgets
                            td_update_to_newspaper6::log('导入小工具');
                            ...
                            // import the settings
                            td_update_to_newspaper6::log('导入主题设置');
                             ...
                             *  - modules
                             */
                            td_update_to_newspaper6::log('更新内容');
                            $args = array(
                            ...
                            td_update_to_newspaper6::log('请重新生成缩略图！');
                        } else {
                            // td_008 - not found
                            td_update_to_newspaper6::log('Newspaper 4 设置在数据库找不到！ td_008 - 找不到');
