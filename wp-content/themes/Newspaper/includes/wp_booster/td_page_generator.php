...
class td_page_generator {
        ...
        if (!empty($category_1_name)) {
            ...
            if (!empty($category_2_name) and td_util::get_option('tds_breadcrumbs_show_parent') != 'hide' ) {
                $breadcrumbs_array [] = array (
                    'title_attribute' => __td('查看所有文章：', TD_THEME_NAME) . ' ' . htmlspecialchars($category_2_name),
                    'url' => $category_2_url,
            ...
            //child category
            $breadcrumbs_array [] = array (
                'title_attribute' => __td('查看所有文章：', TD_THEME_NAME) . ' ' . htmlspecialchars($category_1_name),
                'url' => $category_1_url,
    ...
    static function get_author_breadcrumbs($part_cur_auth_obj) {
        ...
        $breadcrumbs_array [] = array (
            'title_attribute' => '',
            'url' => '',
            'display_name' => __td('作者', TD_THEME_NAME)
        );
        $breadcrumbs_array [] = array (
            'title_attribute' => '',
            'url' => '',
            'display_name' => __td('作者：', TD_THEME_NAME) . ' ' . $part_cur_auth_obj->display_name
        );
    ...
    static function get_tag_breadcrumbs($current_tag_name) {
        ...
        $breadcrumbs_array [] = array (
            'title_attribute' => '',
            'url' => '',
            'display_name' =>  __td('标签', TD_THEME_NAME)
        );
        ...
        $breadcrumbs_array [] = array (
            'title_attribute' => '',
            'url' => '',
            'display_name' =>  __td('文章标签：', TD_THEME_NAME) . ' "' . $current_tag_name . '"'
        );
